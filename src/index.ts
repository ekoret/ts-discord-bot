...
import DatabaseConnectionHandler from './inc/DatabaseConnectionHandler';
...
const main = async () => {
    try {
        const databaseConnectionHandler = new DatabaseConnectionHandler();
        const discordCRUD = await databaseConnectionHandler.startDatabase();
        ...
        client.discordCRUD = discordCRUD;
